...
/* package foldable-0.1.0.0 */
#ifndef VERSION_foldable
#define VERSION_foldable "0.1.0.0"
#endif /* VERSION_foldable */
#ifndef MIN_VERSION_foldable
#define MIN_VERSION_foldable(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_foldable */
...
#define CURRENT_COMPONENT_ID "foldable-0.1.0.0-4h4iNovA9PoAKJLiygZ4KG-foldable"
