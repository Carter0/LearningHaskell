...
/* package applicative-0.1.0.0 */
#ifndef VERSION_applicative
#define VERSION_applicative "0.1.0.0"
#endif /* VERSION_applicative */
#ifndef MIN_VERSION_applicative
#define MIN_VERSION_applicative(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_applicative */
...
#define CURRENT_COMPONENT_ID "applicative-0.1.0.0-1Z9gvicByO1Cq5eGuMhhao-applicative"
