...
/* package functor-0.1.0.0 */
#ifndef VERSION_functor
#define VERSION_functor "0.1.0.0"
#endif /* VERSION_functor */
#ifndef MIN_VERSION_functor
#define MIN_VERSION_functor(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_functor */
...
#define CURRENT_COMPONENT_ID "functor-0.1.0.0-6qkwmRJTsrSKamjxVRt5bj-functor"
