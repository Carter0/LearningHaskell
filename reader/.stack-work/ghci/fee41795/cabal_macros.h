...
/* package reader-0.1.0.0 */
#ifndef VERSION_reader
#define VERSION_reader "0.1.0.0"
#endif /* VERSION_reader */
#ifndef MIN_VERSION_reader
#define MIN_VERSION_reader(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_reader */
...
#define CURRENT_COMPONENT_ID "reader-0.1.0.0-CDh1fMPGpFeKviCOPb5DYT-reader"
